...
function sameSameButDifferent(num, maybeNum){
  if (typeof(num) === 'number' && num === maybeNum) {
...
function myMap(arr, triple){
  let newArr = []
  arr.forEach(function(num){
    newArr.push(triple(num))
  })
  return newArr
}
...
function myMap(arr, greet){
  let newArr = []
  arr.forEach(function(name){
    newArr.push(greet(name))
  })
  return newArr
}
